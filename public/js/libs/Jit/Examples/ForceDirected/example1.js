            ...
            'checkedlog':{
                'render':function (node, canvas) {
                    ...
                    if (node.getData('checked')){
                        ...
                        ctx.beginPath();
                        ctx.arc(x - w + 5, y  + 5, 4, 0, Math.PI * 2, true);
                        ctx.closePath();
                        ctx.fill();
                ...
                'contains': function(node, pos){
                   ...
                   console.log('dy:',  dy, 'pos: ', pos.x,',', pos.y, ', node pos: ', npos.x, npos.y, width, height);
...
function _outline_nodes(fd) {
    fd.graph.eachNode(function (node) {
        var ctx = fd.canvas.getCtx();
        ctx.strokeStyle = 'rgb(256, 128, 128)';
        ctx.strokeRect(node.pos.x, node.pos.y, 200, 200);
    });
}
